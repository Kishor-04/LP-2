...
echo.
echo [1/4] Downloading index.html...
curl -L -o "PR-7(Participant List)\participants.html" "https://raw.githubusercontent.com/Kishor-04/LP-2/main/PR-7(Participant%%20List)/participants.html" && echo [SUCCESS] participants.html downloaded!
echo [2/4] Downloading style.css...
curl -L -o "PR-7(Participant List)\participants.css" "https://raw.githubusercontent.com/Kishor-04/LP-2/main/PR-7(Participant%%20List)/participants.css" && echo [SUCCESS] participants.css downloaded!
echo [3/4] Downloading script.js...
curl -L -o "PR-7(Participant List)\participants.js" "https://raw.githubusercontent.com/Kishor-04/LP-2/main/PR-7(Participant%%20List)/participants.js" && echo [SUCCESS] participants.js downloaded!
echo [4/4] Downloading script.js...
curl -L -o "PR-7(Participant List)\participants.json" "https://raw.githubusercontent.com/Kishor-04/LP-2/main/PR-7(Participant%%20List)/participants.json" && echo [SUCCESS] participants.json downloaded!
echo.
echo ========================================
